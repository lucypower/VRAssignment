...
public class MasterController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        m_RightController = RightTeleportInteractor.GetComponent<XRController>();
        m_LeftController = LeftTeleportInteractor.GetComponent<XRController>();
